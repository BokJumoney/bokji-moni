...
async def compare_datas(repo:WelfareRepository, api_serv_ids_list: list): #
    ...
    ingest_to_pgvector(chunked_df) # df -> document -> PGVector + SQLModel
...
async def api_call_rag_update(session:Session):
    ...
    await compare_datas(welfare_repository, serv_id_list) #DB꺼랑 비교하러 ㄱㄱ링
    pass
